//
//  DayTableTableViewController.swift
//  SSProj
//
...
class DayTableViewController: UITableViewController {
    ...
    case .DefaultMode:
    let realm = Realm()
    days = realm.objects(day).sorted("modificationDate", ascending: false) //1
...
extension DayTableViewController: UITableViewDataSource {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier("DayCell", forIndexPath: indexPath) as! DayTableViewCell //1
        
        let row = indexPath.row
        let day = days[row] as Day
        cell.day = day
...
extension DayTableViewController: UITableViewDelegate {
...
extension DayTableViewController: UISearchBarDelegate {
